...
function TodoItem({ todoId }) {
  const todo = useStoreSelector('todos', store => 
...
function TodoStats() {
  const completedCount = useStoreSelector('todos', store => store.completedCount);
...
function CartSummary() {
  const total = useStoreSelector('cart', store => store.total);
...
function CartIcon() {
  const itemCount = useQuantaSelector(cartStore, store => store.itemCount);
...
function ProductList() {
  ...
  const products = useStoreSelector('products', store => store.filteredProducts);
...
function ProductCard({ productId }) {
  ...
  const product = useStoreSelector('products', store => 
...
function ProductFilters() {
  ...
  const filters = useStoreSelector('products', store => store.filters);
  const updateFilters = useStoreSelector('products', store => store.updateFilters);
