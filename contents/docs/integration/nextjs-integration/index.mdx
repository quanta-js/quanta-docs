...
description: App Router, Server Components and per-request state isolation with QuantaJS.
---
...
QuantaJS handles this with [containers](/docs/api/containers). The pattern
