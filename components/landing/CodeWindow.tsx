        ...
        >
            ...
            <div className="p-6 overflow-x-auto relative">
                ...
                <pre ref={codeRef} className="pl-4 text-[#D4D4D4] leading-relaxed font-fira-code text-xs md:text-sm">
                    <div className="code-line h-6 leading-6" dangerouslySetInnerHTML={{ __html: `<span style="color: #C586C0">import</span> <span style="color: #FFD700">{</span> <span style="color: #9CDCFE">defineStore</span> <span style="color: #FFD700">}</span> <span style="color: #C586C0">from</span> <span style="color: #CE9178">'@quantajs/core'</span><span style="color: #CCCCCC">;</span>` }} />
                    <div className="code-line h-6 leading-6" />
                    <div className="code-line h-6 leading-6" dangerouslySetInnerHTML={{ __html: `<span style="color: #569CD6">const</span> <span style="color: #4FC1FF">useCounter</span> <span style="color: #D4D4D4">=</span> <span style="color: #DCDCAA">defineStore</span><span style="color: #FFD700">(</span><span style="color: #CE9178">'counter'</span><span style="color: #CCCCCC">,</span> <span style="color: #FFD700">{</span>` }} />
