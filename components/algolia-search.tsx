  ...
  return (
    <div className="relative border rounded-lg sm:w-fit w-[68%]">
      <div className="absolute right-2 top-[0.4rem] hidden items-center gap-0.5 text-xs font-code sm:flex pointer-events-none">
        <div className="bg-background/30 border rounded-md py-0.5 px-1 dark:border-neutral-700 border-neutral-300 dark:text-gray-300 text-neutral-600">
          Ctrl
        </div>
        <div className="bg-background/30 border rounded-md py-0.5 px-[0.28rem] dark:border-neutral-700 border-neutral-300 dark:text-gray-300 text-neutral-600">
          K
        </div>
      </div>
